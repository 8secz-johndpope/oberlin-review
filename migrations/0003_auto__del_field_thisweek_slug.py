...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ThisWeek.slug'
        db.delete_column('review_thisweek', 'slug')


    def backwards(self, orm):
        
        # We cannot add back in field 'ThisWeek.slug'
        raise RuntimeError(
            "Cannot reverse this migration. 'ThisWeek.slug' and its values cannot be restored.")
