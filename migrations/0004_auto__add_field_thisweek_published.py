...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ThisWeek.published'
        db.add_column('review_thisweek', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ThisWeek.published'
        db.delete_column('review_thisweek', 'published')
